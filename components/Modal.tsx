...
const Modal = forwardRef(({ children, width, button }: ModalProps, ref: Ref<ModalHandle>) => {
    ...
    return (
        <Dialog.Root open={open} onOpenChange={setOpen}>
            ...
            <Dialog.Portal>
                <Dialog.Overlay className="bg-black/50 fixed inset-0 z-50 p-4 overflow-y-auto grid place-items-center transition-all duration-400 data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out">
                    <Dialog.Content
