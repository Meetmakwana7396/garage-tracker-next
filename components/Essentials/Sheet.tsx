            ...
            <Dialog.Portal>
                <Dialog.Overlay className="bg-black/50 fixed inset-0 z-[60] transition-all duration-300 data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out">
                    <Dialog.Content
                        ...
                        className="w-full h-screen absolute overflow-y-auto ease-in-out right-0 transition-transform bg-white shadow-lg p-6 outline-none animate-in slide-in-from-right duration-200 dark:bg-black dark:text-white-dark"
