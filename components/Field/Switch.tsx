...
const SwitchDemo = ({ checked }: ISwitchProps) => (
    <form>
        <div className="flex items-center gap-4 px-2 py-3">
            <Switch.Root
                className="w-[42px] h-[25px] rounded-full bg-gray-300 relative data-[state=checked]:bg-primary dark:data-[state=checked]:bg-primary outline-none cursor-default dark:bg-supporting/20"
                checked={checked}
            >
